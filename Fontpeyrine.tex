...
\chanson[position=2col,numero=1]{ly/ViergeDeFontpeyrine/ViergeDeFontpeyrine}

\titre{C'est le Périgord}
\lilypondfile[staffsize=15]{ly/CestLePerigord/CestLePerigord.ly}
\chanson[position=2col,numero=1]{ly/CestLePerigord/CestLePerigord}
...
{\titre{Bénédiction solennelle de la Croix du Jubilé}}
\versio{%
...
\versio{Orémus,
Béne ✠ dic, Dómine Jesu Christe, hanc Crucem, per quam eripuísti mundum a potestáte daémonum,
